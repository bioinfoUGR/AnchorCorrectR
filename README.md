![anchorCorrectR logo](man/figures/anchorCorrectR-logo.png)
...
![MDS balanced ridge](man/figures/readme/mds_balanced_ridge.png)

![MDS balanced anchor-aware ComBat](man/figures/readme/mds_balanced_combat.png)
...
![MDS anchor-aware ComBat vs ComBat_seq at 2 replicates](man/figures/readme/mds_strong_nrep2_combat_vs_combatseq.png)
...
![PRECISESADS PCA outlier detection](man/figures/readme/qc_examples/pca_outliers_precisesads.jpg)

![PRECISESADS MDS outlier detection](man/figures/readme/qc_examples/mds_outliers_precisesads.jpg)
...
![PRECISESADS sex mismatch and contamination](man/figures/readme/qc_examples/sex_mismatch_precisesads.jpg)
...
**PRECISESADS example** (threshold ≈ 0.6): left panels show per-RNA-sample SNP depth and concordance scores against DNA references (boxplots + best/matching IDs). Green points are correct same-ID matches above the threshold; pink highlights a best match to a **different** DNA ID (possible swap). The pie
...
![PRECISESADS RNA-DNA concordance](man/figures/readme/qc_examples/rna_dna_concordance_precisesads.jpg)
